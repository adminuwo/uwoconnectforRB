...
from .views import (
    ...
    InstagramEmbeddedSignupView, FacebookEmbeddedSignupView, InstagramOAuthCallbackView, InstagramSyncMessagesView,
...
urlpatterns = [
    ...
    path('client/instagram/sync', InstagramSyncMessagesView.as_view(), name='instagram-sync-messages'),
    path('client/instagram/sync/', InstagramSyncMessagesView.as_view()),
